    ...
    <div class="main">
        <div class="container-fluid" id="info" style="padding: 0%;">
            ...
            <form action="services.php" method="post">
                <div class="box info">
                    <div class="dropdown">
                        <select class="btn titles" id="f-title" name="title">
                        ...
                        <input type="text" class="Firstname" id="f-firstname" name="firstname" placeholder="&nbsp;&nbsp;Firstname">
                        <input type="text" class="Lastname" id="f-lastname" name="lastname" placeholder="&nbsp;&nbsp;Lastname">
                    </div>
                    <h5 style="margin: 3% 0 1% 3%;">Date of birth</h5>
                    <input type="date" class="birthDate" id="f-date_of_birth" name="date_of_birth">
                    <h5 style="margin:1% 0 0 3%;">Contact Information</h5>
                    <input type="text" class="MobilePhone" id="tel" name="tel" placeholder="&nbsp;&nbsp;Mobile Phone">
                    <input type="text" class="Email" id="f-email" name="email" placeholder="&nbsp;&nbsp;Email">
                </div>
                ...
                <div class="row" id="rowMove">
                    ...
                    <div class="col-6">
                        <input type="submit" onclick="handleSubmit()" value="Next" class="btn next">
                    </div>
                </div>
            </form>
